...
# ========= Layout ========= #
layout = dbc.Card([
                html.H1("ASM", className="text-primary", style={'text-align': 'center'}),
...
# Seção NAV ------------------------
            ...
            dbc.Nav(
                [   
                    dbc.DropdownMenu([
                        dbc.DropdownMenuItem(dbc.NavLink(" DRE 2022", href="/dashboards", active="exact")),
                        dbc.DropdownMenuItem(dbc.NavLink(" DRE de Setembro", href="/dresetembro", active="exact")),
                        dbc.DropdownMenuItem(dbc.NavLink(" DRE de Outubro", href="/dreoutubro", active="exact")),
                        dbc.DropdownMenuItem(dbc.NavLink(" DRE de Novembro", href="/drenovembro", active="exact")),
                        dbc.DropdownMenuItem(dbc.NavLink(" DRE de Dezembro", href="/dredezembro", active="exact")),
                
                ],label="Kpis Economico",nav=True,),
